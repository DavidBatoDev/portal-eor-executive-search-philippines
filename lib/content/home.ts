...
export const hero = {
  ...
  // Headline as segments so the gold emphasis can fall on the core services
  // ("Philippine-wide hiring", "workforce support") rather than the audience.
  // The concatenated text is unchanged from the source copy.
  headline: [
