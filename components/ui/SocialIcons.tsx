// Brand social glyphs, ported verbatim from the footer markup.
...
export function XIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M18.24 2.25h3.31l-7.23 8.26L22.84 21.75h-6.66l-5.21-6.82-5.97 6.82H1.69l7.73-8.84L1.16 2.25h6.83l4.71 6.23 5.54-6.23Zm-1.16 17.52h1.83L7.01 4.13H5.04l12.04 15.64Z" />
    </svg>
  );
}
