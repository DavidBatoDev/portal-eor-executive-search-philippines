  ...
  return (
    ...
    >
      ...
      <Container className="relative z-2 grid items-center gap-[clamp(2.5rem,4.5vw,5rem)] lg:grid-cols-[1.04fr_.96fr]">
        ...
        <div className="edge-gold relative hidden rounded-lg border border-white/10 bg-white/[.04] p-5 shadow-[0_24px_60px_rgba(0,0,0,.28)] backdrop-blur-sm lg:block">
          ...
          <div className="flex flex-col">
            {services.map((s, i) => (
              <Link
                ...
                href={s.href}
                className={cx(
                  "group relative flex items-center gap-3 rounded-xl p-[.6rem_.5rem] transition-colors hover:bg-gold/[.08]",
