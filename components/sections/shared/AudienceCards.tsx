          ...
          {cards.map((c, i) =>
            solo ? (
              <Reveal
                ...
                className="flex flex-col items-start gap-[1.1rem] rounded border border-border bg-white p-6 shadow-sm transition-[transform,box-shadow] duration-200 hover:-translate-y-[3px] hover:shadow"
              >
