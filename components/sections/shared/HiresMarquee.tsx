...
function HireCard({ card, duplicate }: { card: Hire; duplicate: boolean }) {
  return (
    <article
      ...
      className="flex w-[clamp(300px,32vw,360px)] flex-none flex-col rounded-lg border border-border bg-white p-[1.7rem] shadow-sm transition-[translate,box-shadow,border-color] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-1.25 hover:border-gold hover:shadow-lg hover:duration-150 hover:ease-out"
    >
